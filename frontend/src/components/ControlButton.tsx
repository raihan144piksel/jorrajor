...
interface ControlButtonProps {
    ...
    status: boolean;
    onControl: (device: string, currentStatus: boolean) => void;
    activeColor: "orange" | "blue" | "yellow";
}

const ControlButton: React.FC<ControlButtonProps> = ({ label, device, status, onControl, activeColor }) => {
